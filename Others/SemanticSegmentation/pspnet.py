...
from utils.utils_lrpet import channel_decompose_guss
...
class PSPNet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"        : 'lrpets/best_epoch_weights.pth',
        #----------------------------------------#
        #   所需要区分的类的个数+1
        #----------------------------------------#
        "num_classes"       : 21,
    ...
    def generate(self, onnx=False):
        ...
        #         prun_index = int(tmpS.size(0) - tmpS.size(0)* 0.43)
        #         default_parameters.append(prun_index)
        # self.net = channel_decompose_guss(self.net, default_parameters)
